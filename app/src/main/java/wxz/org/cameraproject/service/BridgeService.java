package wxz.org.cameraproject.service;
...
import wxz.org.cameraproject.ipcamera.utils.MyStringUtils;
...
public class BridgeService extends Service {
    ...
    /**
     * StartPPPPLivestream 之后BridgeService中VideoData返回数据
     ...
     * @param h264Data 0：普清摄像机数据；1：高清摄像机数据
     * @param len      一帧数据大小
     * @param width    一阵数据宽
     * @param height   一帧数据高
     *                 其他参数暂时不做处理
...
//	}
    ...
    private Notification getNotification(String content, String did, boolean isAlarm) {
        ...
        mNotify2 = builder.getNotification();
        notifyManager.notify(1, mNotify2);
        return mNotify2;
    }
